...
fn compile_c(input_text: &str, input_file: &str, output_file: &str) {
    write_input(input_file, input_text);
    let output =
        Command::new("cc").arg("-g").arg("-o").arg(output_file).arg(input_file).output().unwrap();
    assert!(output.status.success());
}
...
fn test_union_diff_size_equal() {
    diff_c(
        concat!(
            "union T { struct { char c[2]; } } s;\n", //
            "int main() {}\n"
            ),
        concat!(
            "union T { struct { char c1; char c2; } } s;\n", //
            "int main() {}\n"
        ),
        concat!(
            "  union T\n",
...
fn test_member_diff_bitfield_equal() {
    diff_c(
        concat!(
            "struct T { char a; char c:1; } s;\n", //
            "int main() {}\n"
        ),
        concat!(
            "struct T { char b; char c:1; } s;\n", //
            "int main() {}\n"
        ),
        concat!(
            "  struct T\n",
...
fn test_member_diff_unsized() {
    diff_c(
        concat!(
            "struct T { char a; char b[1]; } s;\n", //
            "int main() {}\n"
        ),
        concat!(
            "struct T { char a; char b[]; } s;\n", //
            "int main() {}\n"
        ),
        concat!(
            "  struct T\n",
...
fn test_member_diff_inline_union_union() {
    diff_c(
        concat!(
            "struct T { union { char b; } a; } s;\n", //
            "int main() {}\n"
        ),
        concat!(
            "struct T { union { char c; } a; } s;\n", //
            "int main() {}\n"
        ),
        concat!(
            "  struct T\n",
...
fn test_enum_diff() {
    diff_c(
        concat!(
            "enum T { A=1, B=2, C=3, D=4, E=5 };\n", //
            "enum T t;\n",
            "int main() {}\n"
        ),
        concat!(
            "enum T { A=1, C=2, B=3, E=5, F=6 };\n", //
            "enum T t;\n",
            "int main() {}\n"
        ),
        concat!(
...
fn test_function_diff_parameters() {
    diff_c(
        ...
        concat!(
            "char F(char b, char c, int d, char f, char g) {}\n", //
            "int main() {}\n"
        ),
        concat!(
            "  fn F\n",
