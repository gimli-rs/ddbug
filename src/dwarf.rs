    ...
    where Endian: gimli::Endianity
{
    ...
    let debug_abbrev = gimli::DebugAbbrev::<gimli::EndianBuf<Endian>>::new(debug_abbrev.unwrap_or(&[]));
    ...
    let debug_ranges = gimli::DebugRanges::<gimli::EndianBuf<Endian>>::new(debug_ranges.unwrap_or(&[]));
